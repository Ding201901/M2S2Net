...
def make_data(dataset: str, patch_size = 5, n_class = 2, flag = 'train'):
    ...
    if dataset == 'China':
        ...
        data_t1 = sio.loadmat(path + '/DataSet/three_data/bayArea/Bay_Area_2013_170.mat')['HypeRvieW']
        data_t2 = sio.loadmat(path + '/DataSet/three_data/bayArea/Bay_Area_2015_170.mat')['HypeRvieW']
    ...
    elif dataset == 'Wetland':
        data = sio.loadmat('E:/DataSet/Wetland/PreImg_2006.mat')
        data_t1 = data['img_2006']
        data = sio.loadmat('E:/DataSet/Wetland/PostImg_2007.mat')
        data_t2 = data['img_2007']
        if n_class == 2:  # the binary ground truth
            y = sio.loadmat('E:/DataSet/Wetland/Reference_Map_Binary.mat')['Ref_map_binary']
        else:  # multiple
            y = sio.loadmat('E:/DataSet/Wetland/Reference_Map_Multiclass.mat')['Ref_map_multiclass']

    img_height, img_width, channel = data_t1.shape
    # normalize data by band norm  TODO: 归一化方式有待研究
    ...
    x = np.transpose(np.concatenate((patches_t1, patches_t2), axis = -1), (0, 3, 1, 2))  # ->[b,2*c,p,p]
